    ...
    <div className="relative min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black overflow-hidden">
      ...
      <nav className="relative z-20 flex items-center justify-between px-6 py-6 lg:px-12">
        <div className="hidden md:flex items-center space-x-8">
          {["Services", "Tracking", "Pricing", "Contact"].map((item, index) => (
            <a
              key={item}
              href="#"
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[600px]">
          ...
          <div className="space-y-12">
            <div className="space-y-8">
              <div className="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-xl border border-white/20 text-white px-6 py-3 rounded-full text-sm font-semibold shadow-2xl relative overflow-hidden group">
                ...
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse relative z-10 shadow-lg shadow-green-400/50" />
                <Sparkles className="w-4 h-4 text-yellow-400 relative z-10 animate-pulse" />
              </div>
