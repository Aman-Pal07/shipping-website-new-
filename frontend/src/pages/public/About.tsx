    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <AnimateOnScroll>
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Your trusted partner in international shipping and package tracking
          </p>
        </div>
      </AnimateOnScroll>
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-muted-foreground mb-6 text-lg leading-relaxed">
              ...
              and provide transparent, reliable tracking for all your packages.
              We believe in making global commerce accessible to everyone by
              removing the complexity and uncertainty from international
              shipping.
            </p>
      ...
      <AnimateOnScroll delay={0.6}>
        <div className="mb-16 text-center">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-muted-foreground mb-6 text-lg leading-relaxed">
              Parcel Up was founded in 2021 by a team of logistics professionals
              who saw the need for a more transparent and customer-friendly
              approach to international shipping. After experiencing the
              frustrations of lost packages, delayed shipments, and poor
              communication firsthand, our founders decided to create a
              solution.
            </p>
            <p className="text-muted-foreground mb-6 text-lg leading-relaxed">
      ...
      <AnimateOnScroll delay={0.8}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-gradient-to-br from-purple-600 to-pink-600 text-white rounded-xl p-8 text-center shadow-lg">
            ...
            <div className="text-purple-100 text-lg">Customer Satisfaction</div>
          </div>
